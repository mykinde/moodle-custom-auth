...
<div class="container">
    ...
    <form method="POST" action="" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="idnumber" class="form-control" required maxlength="11" value="<?= $fields['idnumber'] ?>">
        </div>

        <div class="col-md-6">
            <label class="form-label">Confirm ID Number</label>
            <input type="text" name="confirm_id" class="form-control" required maxlength="11" value="<?= $fields['confirm_id'] ?>">
        </div>
    ...
    "DSC" => "Data Science",
    "ECO" => "Economics",
    "EMT" => "Employment Management and Taxation",
    "ERM" => "Employment Relations and Human Resource Management",
    "ENG" => "English Language",
    "BFN" => "Finance",
    "FAA" => "Fine and Applied Art",
    "FST" => "Food Science & Technology",
    "FOD" => "Foundation",
    "GEO" => "Geology",
    "GEP" => "Geophysics",
    "ICT" => "Information and Communication Technology",
    "IRP" => "Industrial Relations & Personnel Management",
    ...
    "NTG" => "Non Teaching/Academic",
    "NUR" => "Nursing Science",
    "PHY" => "Physics",
    "PEL" => "Physics With Electronics",
    "PUD" => "Public Administration",
    "PHT" => "Public Health",
    "RES" => "Religious Studies",
    "SIV" => "Securities and Investment",
    "SWE" => "Software Engineering"
        ...
        <div class="col-md-6">
            ...
            <select name="institution" class="form-select" required>
                ...
                <?php
                $institutions = [
				"CHMS" => "Humanities & Management Sci",
